...
def generate_lyrics(text_model, text_file):
	...
	while len(bars) < poem_num_of_lines:
		#print("looping, count: " + str(count) + ", lenbars: " + str(len(bars)) + ", lyriclength: " + str(lyriclength))
...
def vectors_into_song(vectors, generated_lyrics, rhyme_list):
	...
	def calculate_score(vector_half, syllables, rhyme, penalty):
		...
		#print ("desired_syllables: " + str(desired_syllables))
		#print ("syllables: " + str(syllables))
		#print ("desired_rhyme: " + str(desired_rhyme))
		#print ("rhyme: " + str(rhyme))
...
train_mode = True
cwd = os.getcwd()
with os.scandir(cwd+'/input/') as root_dir:
	for path in root_dir:
		if path.is_file():
			artist = path.name[0:-4]
			text_file = "input/" + artist + ".txt"
			main(depth, train_mode)

#train_mode = False
#main(depth, train_mode)   ## For producing an output